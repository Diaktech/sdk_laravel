...
use App\Http\Controllers\Collecteur\PromotionController;
...
// ==================== ROUTES POUR LES TEST DU CODE PROMOTIONNELLE ====================
Route::post('/collecteur/promotions/verifier', [App\Http\Controllers\Collecteur\PromotionController::class, 'verifier'])
    ->name('collecteur.promotions.verifier');
